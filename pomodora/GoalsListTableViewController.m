...
- (void)viewDidLoad
{
    ...
    self.goals = [[NSMutableArray alloc] initWithObjects:@"Red", @"Blue", @"Green", nil];
    ...
    UIBarButtonItem *addButtonItem = [[UIBarButtonItem alloc]
                                      initWithBarButtonSystemItem:UIBarButtonSystemItemAdd target:self action:@selector(addGoal)];
